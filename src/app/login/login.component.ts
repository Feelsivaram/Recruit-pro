...
export class LoginComponent implements OnInit {
    ...
    login1(obj) {
        ...
        if (obj.emailid == 'ceo' || obj.emailid == 'bdm' || obj.emailid == 'brd') {
            var fakeUserDetials = {
                emailId: obj.emailid + '@email.com',
                type: obj.emailid,
                phone: 9676551157,
                image: '../../assets/myavathar.png'
            }
            this.userDetials.setUserDetails(fakeUserDetials);
