...
export class OpenrequirementsComponent implements OnInit {
    ...
    constructor(private dialogRef: MatDialogRef<OpenrequirementsComponent>, @Inject(MAT_DIALOG_DATA) public data) { }



    ngOnInit() {
        if (this.data.JobData) {
            this.JobDetails = this.data.JobData;
        }
    }
    //   save() {
