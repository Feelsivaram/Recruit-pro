...
@Component({
  selector: 'app-brdopenrequirements',
  templateUrl: './brdopenrequirements.component.html',
  styleUrls: ['./brdopenrequirements.component.css']
})
export class BrdopenrequirementsComponent implements OnInit {
  v: object[] = [];
  display: 'none';
  tru: boolean = false;
  form:FormGroup;
